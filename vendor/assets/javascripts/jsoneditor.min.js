...
// Color needs special attention.
         ...
         * Adds an error chat to the specified input element.
         *
         * @param {HTMLElement} input The input element that caused the error.
         * @param {string} text The error chat.
         */
